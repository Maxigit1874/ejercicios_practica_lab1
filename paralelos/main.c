...
void ordenarAlumnos(int leg[], int age[], char sexo[], int nota1[], int nota2[], float promedio[], int tam);
...

{
    ...
    */
    ...
    ordenarAlumnos (legajos, edades, sexos, notasp1, notasp2, promedios, TAM);
